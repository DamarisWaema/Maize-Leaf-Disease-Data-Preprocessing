...
seq = iaa.Sequential([
    iaa.Flipud(1.0)], # vertical flip 1.0 is the flip probability. Means that all images will be flipped.
...
if __name__ == '__main__':
    ...
    output_folder = os.path.join('..', f'{folder}_VirticalFlip')
    ...
    df = pd.read_csv(os.path.join('..', 'annotations', f'annotationsFor50SelectedTestImages.csv'))
    ...
    # save new DataFrame
    aug_df.to_csv(os.path.join('..', 'annotations', f'annotationsFor50SelectedTestImages_VF.csv'))
