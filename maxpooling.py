...
if __name__ == '__main__':
    ...
    output_folder = os.path.join('..', f'{folder}-MaxPooling') #Change here
    ...
    df = pd.read_csv(os.path.join('..', 'annotations', f'annotationsTest.csv'))
    ...
    # save new DataFrame
    aug_df.to_csv(os.path.join('..', 'annotations', f'annotationsTest-Maxpooling.csv'))
